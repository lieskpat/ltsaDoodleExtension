...
class SubscriberController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
    ...
    \Schmidtch\Survey\Domain\Model\Survey $survey, \Schmidtch\Survey\Domain\Model\Subscriber $subscriber) {
    ...
    \Schmidtch\Survey\Domain\Model\Survey $survey, \Schmidtch\Survey\Domain\Model\Subscriber $subscriber = NULL) {
        $this->view->assign('survey', $survey);
        $this->view->assign('subscriber', $subscriber);
    }
