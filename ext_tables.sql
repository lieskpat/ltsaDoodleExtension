#
# Table structure for table 'tx_survey_domain_model_organizer'
#
CREATE TABLE tx_survey_domain_model_organizer (
...
#
# Table structure for table 'tx_survey_domain_model_survey'
#
CREATE TABLE tx_survey_domain_model_survey (
...
CREATE TABLE tx_survey_domain_model_subscriber (
	...
	name_subscriber varchar(255) DEFAULT '' NOT NULL,
	comments int(11) unsigned DEFAULT '0' NOT NULL,
	subcheck int(11) unsigned DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_survey_domain_model_appointment (
	...
	appointment_date datetime DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE tx_survey_domain_model_timeofday (
	...
	time_check int(11) unsigned DEFAULT '0' NOT NULL,
