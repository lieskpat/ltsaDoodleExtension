...
/**
 * Test case for class \Schmidtch\Survey\Domain\Model\Organizer.
 *
...
class OrganizerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	{
		$this->subject = new \Schmidtch\Survey\Domain\Model\Organizer();
	}
	 ...
	 * @test
	 */
	public function getFeUserUidReturnsInitialValueForInt()
	{	}

	/**
	 * @test
	 */
	public function setFeUserUidForIntSetsFeUserUid()
	{	}
}
