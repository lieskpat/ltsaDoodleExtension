...
page {
	...
	includeJS {
		jquery = web/typo3conf/ext/survey/Resources/Public/Bootstrap/js/jquery.js
		jquery.external = 1
		bootstrap = web/typo3conf/ext/survey/Resources/Public/Bootstrap/js/bootstrap.min.js
...
ajaxAdd {
	...
	100 < tt_content.list.20.survey_surveylisting
}
